...
Here the validation Accuracy is 86% and loss of 12%. Let us try using regularization and drop out techniques
...
Here the validation Accuracy is 87% and loss of 11%. But the accuracy is lesser when compared to the previous one. We can try to improve the model by using both the techniques regularization and dropout
...
Here the validation Accuracy is 87% and loss of 13%. We can try to improve the model by using more hidden layers.
...
Here the validation Accuracy is 86% and loss of 11%. We can try to improve the model by using regularization with the same hidden layers.
...
This method gives an accuracy of 88%
